...
ESFJ: {
    ...
    best: "Na",
    best_ko: "나트륨",
    best_comment: "탄산칼슘(CaCO₃)과 나트륨(Na)은 안정적인 반응을 통해 서로를 보완하며 함께 존재할 수 있어요..",
    worst: "Li",
    worst_ko: "리튬",
    worst_comment: "탄산칼슘(CaCO₃)과 리튬(Li)이 만나면 격렬한 화학 반응을 일으켜 폭발할 수 있어요."
},
...
ENTJ: {
    ...
    best: "Li",
    best_ko: "리튬",
    best_comment: "철(Fe)과 리튬(Li)은 서로 안정적인 금속 화합물을 형성해요. 리튬이 전자를 잃고 철과 결합하면서 안정적인 결합 구조를 형성해, 지속 가능한 상호작용을 유지해요.",
    worst: "C",
    worst_ko: "탄소",
